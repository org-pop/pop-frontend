...
class SearchBar extends HTMLElement {
  ...
  render() {
    this.innerHTML = `
      <div class="min-w-2xl">
        <form id="search-form" role="search" class="flex items-center justify-between border-2 border-primary gap-3 rounded-full px-6 bg-surface focus:border-secondary transition-colors">
          <input
            type="text"
            id="search-input"
            autocomplete="off"
        ...
        <ul id="suggestions-list"
            ...
            class="absolute left-0 right-0 mt-2 bg-surface border border-primary/20 rounded-lg shadow-lg overflow-hidden hidden z-50">
        </ul>
      </div>
    `;
